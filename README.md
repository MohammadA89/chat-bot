...
| ویرایش | مدل به‌جای اعمال تغییر، آن را توصیف یا فقط اعلام کرده | harness خودش یک بار مدل را وادار به اجرا می‌کند؛ اگر باز هم توصیف کرد مدل قوی‌تری انتخاب کنید |
